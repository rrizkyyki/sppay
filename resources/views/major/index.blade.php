...
@push('search-bar-responsive')
    ...
    <li class="nav-item dropdown no-arrow d-sm-none">
        ...
        <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
            ...
            <form action="/major" method="GET" class="form-inline mr-auto w-100 navbar-search">
                <div class="input-group">
...
<div class="card shadow mb-4">
    <div class="card-header py-3 justify-content-between d-flex">
        <div class="left-navigation">
            ...
            <h6 class="m-0 font-weight-bold text-primary">Total : {{$majors->count()}}</h6>
        </div>
        <div class="right-navigation">
            <a href="{{route('major.export_excel_view')}}" class="btn btn-sm btn-success font-weight-bold my-1 w-100"><i class="fa fa-download" aria-hidden="true"></i> Excel</a>
            <a href="{{route('major.create')}}" class="m-0 btn btn-sm btn-primary font-weight-bold w-100"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</a>
        </div>
    </div>
