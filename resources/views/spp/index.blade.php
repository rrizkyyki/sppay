...
<form action="/spp" method="GET"
    ...
    <div class="input-group">
        <input type="search" name="search" class="form-control bg-light border-0 small" placeholder="Cari spp..."
...
@push('search-bar-responsive')
    ...
    <li class="nav-item dropdown no-arrow d-sm-none">
        ...
        <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
            ...
            <form action="/spp" method="GET" class="form-inline mr-auto w-100 navbar-search">
                <div class="input-group">
                    <input type="search" name="search" class="form-control bg-light border-0 small"
                        placeholder="Cari spp..." aria-label="Search"
...
<div class="card shadow mb-4">
    <div class="card-header py-3 justify-content-between d-flex">
        <div class="left-navigation">
            ...
            <h6 class="m-0 font-weight-bold text-primary">Total : {{$countSpp}}</h6>
        </div>
